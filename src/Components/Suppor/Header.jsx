...
const handleSelect = (country) => {
  ...
  return (
    <div className=' px-[20px] md:px-[80px] bg-[#0d0d0d] py-[20px] md:py-[40px]  w-[100%] md:flex md:justify-between'>
      <div className='w-[100%] md:w-[32%]'>
        ...
        <div className='mt-[20px] h-[350px] w-[100%]'>
          <img className='object-center object-cover h-[100%] w-[100%]' src="/public/Sub Container.png" alt="" />
        </div>
      </div>
      <div className='w-[100%] md:flex flex-wrap gap-[20px] md:w-[64%] bg-[#0b0b0b] p-[40px] rounded-[9px] border-[1px] border-[rgba(38,38,38,1)]'>
<div className='w-[100%] md:w-[48%] flex flex-col h-[110px]'>
...
<div className='w-[100%] md:w-[48%] flex flex-col h-[110px]'>
  <label htmlFor="lastName" className='text-white text-[18px] font-semibold'>Last Name</label>
  <input id='lastName' type="text" placeholder='Enter Your Last Name' className='w-[100%] text-white bg-[rgba(20,20,20,1)] p-[15px] rounded-[9px] mt-[10px] border-[1px] border-[rgba(38,38,38,1)] placeholder:text-[rgba(153,153,153,1)] text-[18px]'/> 
</div>
<div className='w-[100%] md:w-[48%] flex flex-col h-[110px]'>
  <label htmlFor="email" className='text-white text-[18px] font-semibold'>Email</label>
  <input id='email' type="email" placeholder='Enter Your Email' className='w-[100%] text-white bg-[rgba(20,20,20,1)] p-[15px] rounded-[9px] mt-[10px] border-[1px] border-[rgba(38,38,38,1)] placeholder:text-[rgba(153,153,153,1)] text-[18px]'/> 
</div>
<div className='w-[100%] md:w-[48%] flex flex-col h-[110px]'>
  <label htmlFor="number" className='text-white text-[18px] font-semibold'>Phone Number</label>
...
<div
  ...
  className='bg-[rgba(20,20,20,1)] p-[17px] rounded-[9px] border border-[rgba(38,38,38,1)] flex items-center justify-between cursor-pointer w-[90px]'
>
  <img src={selectedCountry.flag} className='w-[32px] h-[22px]' />
  <ChevronDown
    size={24}
  ...
  {/* большой dropdown */}
  {open && (
    <div className='absolute left-0 top-[70px] w-[100%] md:w-[400px] bg-[rgba(20,20,20,1)] border border-[rgba(38,38,38,1)] rounded-[9px] p-[15px] z-50'>
  ...
  className='w-[100%] text-white bg-[rgba(20,20,20,1)] p-[15px] rounded-[9px] mt-[10px] border-[1px] border-[rgba(38,38,38,1)] placeholder:text-[rgba(153,153,153,1)] text-[18px]'/> 
</div>
</div>
<div className='w-[100%] flex flex-col '>
  <label htmlFor="message" className='text-white text-[18px] font-semibold'>Message</label>
  <textarea name="" id="message" placeholder='Enter Your Message' className='w-[100%] h-[140px] text-white bg-[rgba(20,20,20,1)] p-[15px] rounded-[9px] mt-[10px] border-[1px] border-[rgba(38,38,38,1)] placeholder:text-[rgba(153,153,153,1)] text-[18px]'></textarea>
  </div>
  <div className='md:flex md:justify-between w-[100%] items-center'>
   <label htmlFor="" className='flex gap-[10px] items-center'> <input type="checkbox" /><p className='text-[rgba(153,153,153,1)] text-[18px]'>I agree with Terms of Use and Privacy Policy</p></label>
  <button className='text-white bg-[rgba(229,0,0,1)] py-[14px] px-[24px] text-[18px] font-semibold rounded-[9px]'>Send Message</button>
  </div>
      </div>
    </div>
  )
