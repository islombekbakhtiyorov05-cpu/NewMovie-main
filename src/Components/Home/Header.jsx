...
const Header = () => {
    return (
        <div className='w-full min-h-screen bg-linear-to-b from-[rgba(0,0,0,0.8)] to-[#0f0e0e] flex flex-col items-center overflow-hidden'>
            {/* Иконка/Дизайн сверху */}
            <div className='mt-[60px] md:mt-[100px]'>
                <img 
                    src="/public/Abstract Design.png" 
                    alt="" 
                    className='w-[200px] md:w-auto' // Чуть уменьшил для мобилок
                />
            </div>

            {/* Контентная часть */}
            <div className='w-full flex flex-col items-center mt-[40px] md:mt-[100px] px-[20px] md:px-[220px]'>
                
                {/* Заголовок: уменьшаем размер шрифта на мобилках */}
                <h1 className='text-white text-[28px] md:text-[48px] font-bold text-center'>
                    The Best Streaming Experience
                </h1>

                {/* Описание: убираем жесткий br и огромные отступы */}
